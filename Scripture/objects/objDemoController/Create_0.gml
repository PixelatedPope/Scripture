...
testString = 
	wait(60)+ bleep.open + welcomeTo.open+outline.open+"WELCOME TO\n<60>"+outline.close+welcomeTo.close + bleep.close + 
	scripture.open + "SCRIPTURE" + scripture.close + "\b" + wait(30) +
...
.options = scripture_build_options(1000, 0, fa_center, fa_middle, 1, -20);