...
testString = wait(60)+welcomeTo.open+"WELCOME TO\n<60>"+welcomeTo.close+scripture.open + "SCRIPTURE" + scripture.close + flyIn.open + "\nadvanced text rendering" + flyIn.close;
width = 200
height = 400

instance_create_depth(room_width / 2,room_height/ 2,0,objExampleText1)
.options = scripture_build_options(undefined, fa_center, fa_middle, 1, 1000, 0, 5, false);